...
export const api = {
	get: <T>(url: string, params?: any, config?: any) => axiosInstance.get<T>(url, { params, ...config }),
	...
	delete: <T>(url: string, params?: any, config?: any) => axiosInstance.delete<T>(url, { params, ...config }),
};
